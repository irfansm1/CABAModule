...
import { DetailsList, SelectionMode, Checkbox, SearchBox, DetailsListLayoutMode, TextField, DefaultButton, PrimaryButton, DatePicker, Dropdown, Icon, Dialog, DialogFooter, DialogType, } from 'office-ui-fabric-react';
...
var spCrudObj;
var CABAAdminDashboards = (function (_super) {
    __extends(CABAAdminDashboards, _super);
    function CABAAdminDashboards(props) {
    ...
    CABAAdminDashboards.prototype.componentDidMount = function () {
    ...
    CABAAdminDashboards.prototype.render = function () {
        var _this = this;
        var cabaAdminData = this.state.cabaAdminData;
        return (React.createElement("div", null,
            this.state.Submitted ? React.createElement(Redirect, { to: '/CabaAdminDashboard' }) : null,
            React.createElement("h4", null, "CABA Admin Dashboard "),
            React.createElement("div", { className: 'text-right' },
                React.createElement("button", { onClick: function () { return _this.newRequestForm(); }, className: styles.btnprimary + ' ' + 'mr-3', style: { height: '34px', border: 'none' } }, "CABA Add"),
                React.createElement("button", { onClick: function () { return _this.newRankForm(); }, className: styles.btnprimary, style: { height: '34px', border: 'none' } }, "Ranking Add")),
    ...
    return CABAAdminDashboards;
}(React.Component));
export default CABAAdminDashboards;

//# sourceMappingURL=CABAAdminDasboard.js.map
