                    ...
                    React.createElement("div", { className: styles.borderedpanel },
                        React.createElement("div", { className: "navbar navbar-expand-sm bg-blue" },
                            React.createElement("ul", { className: "navbar-nav" },
                                ...
                                React.createElement("li", { className: "nav-item" },
                                    React.createElement(NavLink, { to: "/CabaAdmin", activeClassName: "active-link" }, "CABA Admin ")),
                                React.createElement("li", { className: "nav-item" },
                        ...
                        React.createElement("div", { className: 'container mb-4' },
                            React.createElement(Switch, null,
                                ...
                                React.createElement(Route, { path: "/CabaAdmin", exact: true, render: function () { return React.createElement(CabaAdminModule, __assign({}, _this.props)); } }),
