...
import styles from '../../../cabaAdminModule/components/CabaAdminModule.module.scss';
import { SPComponentLoader } from '@microsoft/sp-loader';
import { DetailsList, SelectionMode, Link, Checkbox, SearchBox, DetailsListLayoutMode, TextField, DefaultButton, PrimaryButton, DatePicker, Dropdown, Icon, Dialog, DialogFooter, DialogType, } from 'office-ui-fabric-react';
...
var AdminGroupDashboards = (function (_super) {
    ...
    function AdminGroupDashboards(props) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, EmployeeOps().getEmployee(this.props).then(function (empRes) {
                                _this.setState({
                                    empResData: empRes,
                                    EmployeeID: empRes.Title,
                                    EmployeeName: (empRes.FirstName + ' ' + empRes.LastName),
                                    EmployeeCode: empRes.EmployeeTitle,
        ...
        _this.onEditCabaAdmin = function (items) {
            debugger;
            var editRequest = items;
            _this.setState({
                FlatSpecifications: editRequest.FlatSpecifications,
                flatTypes: editRequest.FlatType,
                societyName: editRequest.SocietyName,
                wing: editRequest.Wing,
                flatNo: editRequest.FlatNo,
                occupancyType: editRequest.OccupancyType,
                officeLocation: editRequest.OfficeLocation,
                editItemId: editRequest.ID,
                ...
                onRender: function (item, index, columns) {
                    ...
                    return React.createElement("div", null,
                        React.createElement(Link, null,
                            React.createElement(Icon, { iconName: 'Edit', onClick: function () { return _this.onEditCabaAdmin(item); } })));
                }
            }
        ];
    ...
    AdminGroupDashboards.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h4", null, "Admin Group"),
            React.createElement("div", { className: 'text-right' },
                React.createElement("button", { onClick: function () { return _this.newRequestForm(); }, className: styles.btnprimary + ' ' + 'mr-3', style: { height: '34px', border: 'none', marginRight: '15px' } }, "Add New Flat "),
                ...
                cabaAdminData.length > 0 && (React.createElement("button", { className: styles.exporttoexcel + ' ' + 'btn-outline-info', onClick: this.downloadExcel },
                ...
                React.createElement("div", null,
                    React.createElement("div", { className: 'form-group row' },
                        React.createElement("div", { className: 'col-md-4 form-group' },
                            ...
                            React.createElement(Dropdown, { placeHolder: 'Please select Flat Specifications', selectedKey: this.state.flatSpecifications, options: this.FlatSpecifications, onChanged: function (e) { return _this.onflatSpecificationsChange; } })),
                        React.createElement("div", { className: 'col-md-4 form-group' },
                ...
                React.createElement("div", null,
                    React.createElement("div", { className: 'form-group row' },
                        React.createElement("div", { className: 'col-md-4 form-group' },
                            ...
                            React.createElement(TextField, { defaultValue: this.state.EmployeeCode, id: "EmployeeCode", name: "EmployeeCode", disabled: true, readOnly: true })),
                        React.createElement("div", { className: 'col-md-4 form-group' },
                            React.createElement("label", null, "Designation"),
                            React.createElement(TextField, { defaultValue: this.state.Designation, id: "Designation", name: "Designation", disabled: true, readOnly: true })),
                        React.createElement("div", { className: 'col-md-4 form-group' },
