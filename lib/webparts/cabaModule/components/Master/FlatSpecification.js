...
var spCrudObj;
var FlatSpecification = (function (_super) {
    __extends(FlatSpecification, _super);
    function FlatSpecification(props) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, MasterAllReqOps().getCABASpecData(this.props).then(function (brrResults) {
                                _this.setState({ flatSpecificationData: brrResults });
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        spCrudObj = _a.sent();
                        this.setState(spCrudObj);
                        if (!(this.state.FlatSpecifications === null || this.state.FlatSpecifications === undefined || this.state.FlatSpecifications.trim() === '')) return [3 /*break*/, 2];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, spCrudObj.updateData("FlatSpecificationsMaster", this.state.editItemId, ObjectRequest, this.props).then(function (brrResults) {
                    ...
                    case 4: return [4 /*yield*/, spCrudObj.insertData("FlatSpecificationsMaster", ObjectRequest, this.props).then(function (brrResults) {
                            alert('Data Saved successfully!');
        ...
        _this.newRequestForm = function () {
            //  this.showDialog();
            _this.setState({ isDialogVisible: true, isEditMode: false, FlatSpecifications: '' });
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        spCrudObj = _a.sent();
                        this.setState(spCrudObj);
                        return [4 /*yield*/, spCrudObj.deleteData("FlatSpecificationsMaster", itemsID, this.props).then(function (response) {
    ...
    FlatSpecification.prototype.componentDidMount = function () {
        this.getFlatSpecifications();
    };
    FlatSpecification.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null,
            this.state.Submitted ? React.createElement(Redirect, { to: '/FlatSpecificationMaster' }) : null,
            React.createElement("h4", null, "Flat Specification Master"),
            ...
            React.createElement("div", { className: 'text-right' },
                React.createElement("button", { onClick: function () { return _this.newRequestForm(); }, className: styles.btnprimary, style: { height: '34px', border: 'none', width: '70px' } },
                    ...
                    " Add")),
            React.createElement(DetailsList, { columns: this.columns, items: this.state.flatSpecificationData }),
                ...
                React.createElement(Dialog, { hidden: !this.state.isDialogVisible, onDismiss: this.closeDialog, dialogContentProps: {
                    ...
                    React.createElement("div", { className: 'form-group row' },
                        React.createElement("div", { className: 'col-md-8' },
                            ...
                            React.createElement("input", { type: "text", onChange: this.handleChange, name: "FlatSpecifications", id: 'FlatSpecifications', value: this.state.FlatSpecifications, className: "form-control" }))),
                    React.createElement(DialogFooter, null,
                        React.createElement(PrimaryButton, { onClick: function () { return _this.requestType(); } }, "Submit"))))));
    };
    return FlatSpecification;
}(React.Component));
export default FlatSpecification;

//# sourceMappingURL=FlatSpecification.js.map
