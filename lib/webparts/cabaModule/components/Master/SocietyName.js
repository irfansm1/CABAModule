...
var spCrudObj;
var SocietyName = (function (_super) {
    __extends(SocietyName, _super);
    function SocietyName(props) {
        ...
        _this.getSocietyNameDataDashboard = function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, MasterAllReqOps().getSocietyNameData(this.props).then(function (brrResults) {
                                _this.setState({ SocietyNameData: brrResults });
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, spCrudObj.updateData("SocietyNameMaster", this.state.editItemId, ObjectRequest, this.props).then(function (brrResults) {
                                alert('Data Updated successfully!');
                                _this.setState({ Submitted: true, isDialogVisible: false, isEditMode: false, editItemId: null });
                                _this.getSocietyNameDataDashboard();
                                return brrResults;
                            })];
                    case 2: 
                    // Update operation
                    return [2 /*return*/, _a.sent()];
                    case 3: return [4 /*yield*/, spCrudObj.insertData("SocietyNameMaster", ObjectRequest, this.props).then(function (brrResults) {
                            alert('Data Saved successfully!');
        ...
        _this.newRequestForm = function () {
            //  this.showDialog();
            _this.setState({ isDialogVisible: true, isEditMode: false, SocietyName: '' });
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        spCrudObj = _a.sent();
                        this.setState(spCrudObj);
                        return [4 /*yield*/, spCrudObj.deleteData("SocietyNameMaster", itemsID, this.props).then(function (response) {
                                alert('Item deleted successfully!');
                                _this.getSocietyNameDataDashboard(); // Refresh the list after deletion
                                return response;
    ...
    SocietyName.prototype.componentDidMount = function () {
        this.getSocietyNameDataDashboard();
    };
    SocietyName.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null,
            this.state.Submitted ? React.createElement(Redirect, { to: '/SocietyName' }) : null,
            React.createElement("h4", null, "Society Name Master"),
            ...
            React.createElement("div", { className: 'text-right' },
                React.createElement("button", { onClick: function () { return _this.newRequestForm(); }, className: styles.btnprimary, style: { height: '34px', border: 'none', width: '70px' } },
                    ...
                    " Add")),
            React.createElement(DetailsList, { columns: this.columns, items: this.state.SocietyNameData }),
                ...
                React.createElement(Dialog, { hidden: !this.state.isDialogVisible, onDismiss: this.closeDialog, dialogContentProps: {
                    ...
                    React.createElement("div", { className: 'form-group row' },
                        React.createElement("div", { className: 'col-md-8' },
                            ...
                            React.createElement("input", { type: "text", onChange: this.handleChange, name: "SocietyName", id: 'SocietyName', value: this.state.SocietyName, className: "form-control" }))),
...
//# sourceMappingURL=SocietyName.js.map
