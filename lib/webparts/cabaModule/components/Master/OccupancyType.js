...
var spCrudObj;
var OccupancyType = (function (_super) {
    __extends(OccupancyType, _super);
    function OccupancyType(props) {
        ...
        _this.getOccupancyTypeDashboard = function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, MasterAllReqOps().getOccupancyTypeData(this.props).then(function (brrResults) {
                                _this.setState({ OccupancyTypeDashboard: brrResults });
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        spCrudObj = _a.sent();
                        this.setState(spCrudObj);
                        if (!(this.state.OccupancyType === null || this.state.OccupancyType === undefined || this.state.OccupancyType.trim() === '')) return [3 /*break*/, 2];
                    ...
                    case 2:
                        ...
                        if (!this.state.isEditMode) return [3 /*break*/, 4];
                        return [4 /*yield*/, spCrudObj.updateData("OccupancyTypeMaster", this.state.editItemId, ObjectRequest, this.props).then(function (brrResults) {
                                alert('Data Updated successfully!');
                                _this.setState({ Submitted: true, isDialogVisible: false, isEditMode: false, editItemId: null });
                                _this.getOccupancyTypeDashboard();
                                return brrResults;
                            })];
                    case 3: 
                    // Update operation
                    return [2 /*return*/, _a.sent()];
                    case 4: return [4 /*yield*/, spCrudObj.insertData("OccupancyTypeMaster", ObjectRequest, this.props).then(function (brrResults) {
        ...
        _this.newRequestForm = function () {
            //  this.showDialog();
            _this.setState({ isDialogVisible: true, isEditMode: false, OccupancyType: '' });
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        spCrudObj = _a.sent();
                        this.setState(spCrudObj);
                        return [4 /*yield*/, spCrudObj.deleteData("OccupancyTypeMaster", itemsID, this.props).then(function (response) {
                                alert('Item deleted successfully!');
                                _this.getOccupancyTypeDashboard(); // Refresh the list after deletion
                                return response;
    ...
    OccupancyType.prototype.componentDidMount = function () {
        this.getOccupancyTypeDashboard();
    };
    OccupancyType.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null,
            this.state.Submitted ? React.createElement(Redirect, { to: '/OccupancyType' }) : null,
            React.createElement("h4", null, "Occupancy Type Master"),
            ...
            React.createElement("div", { className: 'text-right' },
                React.createElement("button", { onClick: function () { return _this.newRequestForm(); }, className: styles.btnprimary, style: { height: '34px', border: 'none', width: '70px' } },
                    ...
                    " Add")),
            React.createElement(DetailsList, { columns: this.columns, items: this.state.OccupancyTypeDashboard }),
                ...
                React.createElement(Dialog, { hidden: !this.state.isDialogVisible, onDismiss: this.closeDialog, dialogContentProps: {
                    ...
                    React.createElement("div", { className: 'form-group row' },
                        React.createElement("div", { className: 'col-md-8' },
                            React.createElement("label", null, "Occupancy Type"),
                            React.createElement("input", { type: "text", onChange: this.handleChange, name: "OccupancyType", id: 'OccupancyType', value: this.state.OccupancyType, className: "form-control" }))),
                    React.createElement(DialogFooter, null,
                        React.createElement(PrimaryButton, { onClick: function () { return _this.requestType(); }, className: styles.btnprimary }, "Submit"))))));
    };
    return OccupancyType;
}(React.Component));
export default OccupancyType;

//# sourceMappingURL=OccupancyType.js.map
