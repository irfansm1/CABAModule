...
var CabaAdminModule = (function (_super) {
    ...
    function CabaAdminModule(props) {
        ...
        _this.cabaAdminReport = function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var reportObjectArray_1;
            return __generator(this, function (_a) {
                try {
                    if (this.state.cabaAdminData != null && this.state.cabaRankDashboard != null) {
                        reportObjectArray_1 = new Array();
                        this.state.cabaAdminData.forEach(function (adminData) {
                            var reportObject = {
                                AuthorId: "",
                                key: 0,
                                ID: "",
                            ...
                            var objectRank = _this.state.cabaRankDashboard.filter(function (object) { return object.EmployeeCode == adminData.EmpCode; });
                            ...
                            reportObjectArray_1.push(reportObject);
                        });
                        //console.log(reportObjectArray);
                        this.setState({ cabaAdminReport: reportObjectArray_1, originalData: reportObjectArray_1 });
        ...
        _this.downloadExcel = function () {
            ...
            var worksheet = XLSX.utils.json_to_sheet(_this.state.cabaAdminReport);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(query !== '' && query.length > 2)) return [3 /*break*/, 3];
                        return [4 /*yield*/, utility.filterData(this.state.originalData, query, ['ID', 'FlatSpecifications', 'FlatType', 'SocietyName', 'Wing', 'FlatNo', 'OccupancyType', 'AssignedTo'])];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.cabaAdminReport()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CabaAdminModule.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h4", null, "CABA Admin Dashboard 12 "),
            ...
            React.createElement(Pivot, { linkSize: PivotLinkSize.large, linkFormat: PivotLinkFormat.tabs },
                ...
                React.createElement(PivotItem, { linkText: 'CABA Dashboard' },
                    React.createElement("div", { className: 'panel' },
                        React.createElement(DetailsList, { items: this.state.cabaAdminReport, columns: this.columReport, setKey: "set", layoutMode: DetailsListLayoutMode.fixedColumns, selectionMode: SelectionMode.none, groupProps: { headerProps: { selectionMode: SelectionMode.none } }, onShouldVirtualize: function () { return false; } }))))));
    };
