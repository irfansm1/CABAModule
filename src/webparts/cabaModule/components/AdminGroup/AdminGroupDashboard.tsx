...
import { DetailsList, SelectionMode,MarqueeSelection,Link ,IColumn,Checkbox, SearchBox, Selection,DetailsListLayoutMode, Fabric, TextField, DefaultButton, PrimaryButton,MessageBar, DatePicker, Dropdown, IDropdownOption, Icon, Dialog, DialogFooter, DialogType,Spinner, SpinnerSize,  } from 'office-ui-fabric-react';
...
//export default class CABAAdminDashboards extends React.Component<ICabaModuleProps> {
     ...
     searchQuery:"",
      ...
      this.columns = [
        ...
        ,
        {
            ...
            const Items = item;
              return<div> 
            <Link><Icon iconName='Edit' onClick={()=> this.onEditCabaAdmin(item)} /></Link>
  ...
  getEmployeeData = async (): Promise<IEmployee> => {
    ...
    return await EmployeeOps().getEmployee(this.props).then(empRes => {
      this.setState({
        empResData:empRes,
  ...
  public _onChange = (evItems) =>{
   ...
   submitCabaRankForm = async() =>{
    ...
    onEditCabaAdmin =(items:IEximCabaProps) =>{
      debugger;
      ...
      const { cabaAdminData} = this.state;
        return(
            <div>
              ...
              style={{height:'34px', border:'none', marginRight:'15px'}}>Add New Flat </button>
          ...
          <div className='form-group row'>
                <div className='col-md-4 form-group'>
                  ...
                  <Dropdown
                        ...
                        onChanged={(e)=>this.onflatSpecificationsChange}
                        
                         // onSelect={(option) => this.setState({ FlatSpecifications: option.key })}
                        />
                </div>
                <div className='col-md-4 form-group'>
          ...
          <div className='form-group row'>
                <div className='col-md-4 form-group'>
                  <label>Employee Code</label>
                   <TextField defaultValue={this.state.EmployeeCode} id="EmployeeCode" name="EmployeeCode" disabled readOnly />
                </div>
                <div className='col-md-4 form-group'>
                  <label>Designation</label>
                  <TextField defaultValue={this.state.Designation} id="Designation" name="Designation" disabled readOnly />
